...
import mini_omni.litgpt.model
from mini_omni.litgpt.utils import find_multiple
...
class Config:
    ...
    def mlp_class(self) -> Type:
        ...
        return getattr(mini_omni.litgpt.model, self.mlp_class_name)
    ...
    def norm_class(self) -> Type:
        ...
        if self.norm_class_name == "RMSNorm":
            ...
            from mini_omni.litgpt.model import RMSNorm
