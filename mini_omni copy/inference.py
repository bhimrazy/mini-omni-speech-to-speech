...
from mini_omni.litgpt import Tokenizer
from mini_omni.litgpt.utils import (
    num_parameters,
)
from mini_omni.litgpt.generate.base import (
    generate_AA,
    generate_ASR,
    generate_TA,
    generate_TT,
...
from mini_omni.litgpt.model import GPT, Config
from lightning.fabric.utilities.load import _lazy_load as lazy_load
from mini_omni.utils.snac_utils import (
    layershift,
    reconscruct_snac,
    reconstruct_tensors,
    get_time_str,
)
from mini_omni.utils.snac_utils import get_snac, generate_audio_data
import whisper
...
class OmniInference:
    ...
    def warm_up(self, sample="mini_omni/data/samples/output1.wav"):
